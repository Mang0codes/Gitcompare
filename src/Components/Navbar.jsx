...
const Navbar = () => {
  ...
  <div className="flex space-x-6 h-full px-3">
    <a
      ...
      className="px-4 border-x-3 flex items-center h-full border-black hover:underline active:underline"
    >
    <span className='bg-yellow-200 h-6 w-18'>Give a </span><img src="/imgs/gitstar.png" className='w-4 h-4 gap-2' alt="" />
     ...
     <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="flex items-center h-full hover:underline active:underline flex-shrink-0"
    >
    Twitter
    </a>
  </div>
